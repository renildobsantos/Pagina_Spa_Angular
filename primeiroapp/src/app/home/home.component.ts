...
export class HomeComponent implements OnInit {
  ...
  listaProfessores: professores[] = [
    { nome: 'Maria', idade: 27, email: 'maria@gmail.com', curso: 'Ciencia da Computacao' },
    { nome: 'Carlos', idade: 25, email: 'Teste@gmail.com', curso: 'Analise e desenvolvimento de sistemas' },
    { nome: 'José', idade: 31, email: 'Teste2@gmail.com', curso: 'Engenharia da computacao' },
    { nome: 'João', idade: 45, email: 'Teste3@gmail.com', curso: 'Sistemas da informacao' }
  ];
